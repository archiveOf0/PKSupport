...
public class AbilityStatus extends SimpleExpression<String> {

    static {
        Skript.registerExpression(AbilityStatus.class, String.class, ExpressionType.COMBINED, "[the] ability status of %player% of %number% slot");
    }
    ...
    protected String[] get(Event event) {
        ...
        if (bendingPlayer.getCooldown(abilities.get(slot)) == -1L)
            return new String[]{""};
        else
            return new String[]{cooldownPrefix};
    }
