...
public class AbilityCooldownSecond extends SimpleExpression<String> {

    static {
        Skript.registerExpression(AbilityCooldownSecond.class, String.class, ExpressionType.COMBINED, "[the] ability cooldown of %player% of %number% slot in second");
    }
    ...
    protected String[] get(Event event) {
        ...
        return new String[]{Long.toString(ms / 1000)};
    }
