...
public class ElementPrefix extends SimpleExpression<String> {

    static {
        Skript.registerExpression(ElementPrefix.class, String.class, ExpressionType.COMBINED, "[the] element prefix of %player% of %number% element");
    }
    ...
    protected String[] get(Event event) {
        ...
        return new String[]{bendingPlayer.getElements().isEmpty() ? haventElement : bendingPlayer.getElements().get(slot).getPrefix()};
    }
    ...
    public String toString(Event event, boolean b) {
        return "PKSUP element prefix expression player: " + player.getSingle(event) + " ";
    }
